...
set_property -dict { PACKAGE_PIN C5   IOSTANDARD LVCMOS33 } [get_ports { tx }];
set_property -dict { PACKAGE_PIN C8   IOSTANDARD LVCMOS33 } [get_ports { rx }];

set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { bit_out }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { bit_in }]; #IO_L16N_T2_13 Sch=rpio_26_r
